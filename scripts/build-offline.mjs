...
const html = `<!doctype html><html lang="zh-Hant"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>暫時無法開啟｜Canis Den</title><script>try{var t=localStorage.getItem("theme");document.documentElement.classList.toggle("dark",t==="dark"||((!t||t==="system")&&matchMedia("(prefers-color-scheme: dark)").matches))}catch{}</script><style>${result.css.replaceAll("</style", "<\\/style")}</style></head><body>${output.exports.markup}</body></html>`
